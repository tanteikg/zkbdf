...
uint32_t getRandom32(unsigned char randomness[5856], int randCount) {
	uint32_t ret;
...
int mpc_AND_verify(uint32_t x[2], uint32_t y[2], uint32_t z[2], View ve, View ve1, unsigned char randomness[2][5856], int* randCount, int* countY) {
...
int mpc_ADD_verify(uint32_t x[2], uint32_t y[2], uint32_t z[2], View ve, View ve1, unsigned char randomness[2][5856], int* randCount, int* countY) {
	uint32_t r[2] = { getRandom32(randomness[0], *randCount), getRandom32(randomness[1], *randCount) };
	*randCount += 4;
...
int mpc_MAJ_verify(uint32_t a[2], uint32_t b[2], uint32_t c[2], uint32_t z[3], View ve, View ve1, unsigned char randomness[2][5856], int* randCount, int* countY) {
	uint32_t t0[3];
	uint32_t t1[3];
...
int mpc_CH_verify(uint32_t e[2], uint32_t f[2], uint32_t g[2], uint32_t z[2], View ve, View ve1, unsigned char randomness[2][5856], int* randCount, int* countY) {
...
int verify(a a, int e, z z) {
	...
	unsigned char randomness[2][5856];
